...
<head>
  ...
  <!-- Favicons-->
  <link rel="icon" href="images/favicon/mylog.png" sizes="32x32">
  <!-- Favicons-->
  <link rel="apple-touch-icon-precomposed" href="images/favicon/mylog.png">
  <!-- For iPhone -->
  <meta name="msapplication-TileColor" content="#00bcd4">
  <meta name="msapplication-TileImage" content="images/favicon/mylog.png">
  <!-- For Windows Phone -->
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <!-- <h1>GOS PIZZA is HERE</h1>  -->
                  <ul class="left">                      
                    <h1><strong><span >GOS Pizza'S HERE</span></strong></h1></li>
                    </ul>
                    <ul class="right hide-on-med-and-down">                        
                        <li><a href="#" class="waves-effect waves-block waves-light"><strong><span>&#8377;<?php echo $balance;?></span></strong></a>
                        </li>
                    </ul>					
                </div>
            </nav>
  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Food tastes better when you eat with family
Veg,Nonveg all types of PiZZaS are Available.</p>
            ...
            <div class="row">
              ...
              <div>
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					echo '<input id="'.$row["id"].'" name="'.$row['id'].'" type="text" data-error=".errorTxt'.$row["id"].'"><div class="errorTxt'.$row["id"].'"></div></td><td><img src="' .$row["img"]. '" height="90" width="90"/></td></tr>';
			  ...
			  <div>
			  <div class="input-field col s12">
                              <button class="btn red waves-effect waves-light right" type="submit" name="action">Order
